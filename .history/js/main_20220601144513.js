...
const main = () => {
  ...
  const handleColorClick = (item, idx) => {
    // Các trường hợp ko xử lý gì. item không tồn tại, có chứa class active, trang tháu là BLOCKING và FINISHED, khi time chạy về 0.
    if (
      !item
    ...
    // Add item to selection. Biến lưu chữ vị trí click selection nhận giá trị. thẻ li được add class active. Nếu trong mảng selection có 2 phần tử thì thoát hàm.
    selection.push(idx);
